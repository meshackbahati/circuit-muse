...
export const INLINE_SVGS: Record<string, InlineEntry> = {
  ...
  'circuit-muse-capacitor-electrolytic': { component: Capacitor, w: 36, h: 56 },
  'wokwi-inductor': { component: Capacitor, w: 56, h: 36 },
  // Electromechanical
  'circuit-muse-relay': { component: Relay, w: 96, h: 96 },
  // Optocouplers
  'circuit-muse-opto-4n25': { component: Opto4N25, w: 80, h: 64 },
  'circuit-muse-opto-pc817': { component: Opto4N25, w: 80, h: 64 },
  // IC
  'circuit-muse-motor-driver-l293d': { component: MotorDriverL293D, w: 100, h: 80 },
  ...
  // Logic gates — examples use both `circuit-muse-logic-gate-*` and `circuit-muse-logic-*` naming
  'circuit-muse-logic-gate-and': { component: GateAnd, w: 72, h: 48 },
  'circuit-muse-logic-gate-or': { component: GateOr, w: 72, h: 48 },
  'circuit-muse-logic-gate-nand': { component: GateNand, w: 72, h: 48 },
  'circuit-muse-logic-gate-nor': { component: GateNor, w: 72, h: 48 },
  'circuit-muse-logic-gate-xor': { component: GateXor, w: 72, h: 48 },
  'circuit-muse-logic-gate-xnor': { component: GateXnor, w: 72, h: 48 },
  'circuit-muse-logic-gate-not': { component: GateNot, w: 72, h: 48 },
  'circuit-muse-logic-and': { component: GateAnd, w: 72, h: 48 },
  'circuit-muse-logic-or': { component: GateOr, w: 72, h: 48 },
  'circuit-muse-logic-nand': { component: GateNand, w: 72, h: 48 },
  'circuit-muse-logic-nor': { component: GateNor, w: 72, h: 48 },
  'circuit-muse-logic-xor': { component: GateXor, w: 72, h: 48 },
  'circuit-muse-logic-xnor': { component: GateXnor, w: 72, h: 48 },
  'circuit-muse-logic-not': { component: GateNot, w: 72, h: 48 },
  // Power
  ...
  // Instruments
  'circuit-muse-instr-voltmeter': { component: Voltmeter, w: 72, h: 56 },
  'circuit-muse-instr-ammeter': { component: Ammeter, w: 72, h: 56 },
