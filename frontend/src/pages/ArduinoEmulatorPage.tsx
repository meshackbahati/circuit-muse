...
const FAQ_ITEMS = [
  ...
  {
    q: "How accurate is CircuitMuse's Arduino emulation?",
    a: 'CircuitMuse uses avr8js, which provides cycle-accurate AVR8 instruction emulation. Every AVR opcode is faithfully emulated at 16 MHz, making it reliable for developing and debugging real firmware before flashing to hardware.',
  },
  {
    q: 'Which Arduino boards can CircuitMuse emulate?',
  ...
  {
    q: 'How is CircuitMuse different from Wokwi?',
    a: 'CircuitMuse is fully self-hosted and open-source under GNU AGPLv3. It uses the same avr8js emulation library as Wokwi but runs entirely on your own machine — no cloud dependency, no registration, no subscription.',
  },
];
...
const JSON_LD: object[] = [
  {
    ...
    name: 'CircuitMuse Arduino Emulator',
    ...
    url: 'https://circuit-muse.dev/arduino-emulator',
  ...
  },
  {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'CircuitMuse', item: 'https://circuit-muse.dev/' },
      {
        ...
        item: 'https://circuit-muse.dev/arduino-emulator',
      },
    ],
  },
];
