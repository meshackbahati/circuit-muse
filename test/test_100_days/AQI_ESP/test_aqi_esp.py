"""
Velxio emulation test for: AQI_ESP

Board:    esp32
Features: wifi, flask, i2c_oled, dht, http_server
Languages: py
...
PROJECT_NAME = 'AQI_ESP'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'flask', 'i2c_oled', 'dht', 'http_server']


class Test_AQI_ESP_StaticAnalysis(unittest.TestCase):
...
class Test_AQI_ESP_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-aqi_esp")
