"""
Velxio emulation test for: Auto_Night_Light_using_LDR_(ESP32_+_MicroPython)
...
PROJECT_NAME = 'Auto_Night_Light_using_LDR_(ESP32_+_MicroPython)'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['ldr']


class Test_Auto_Night_Light_using_LDR_ESP32_plus_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_Auto_Night_Light_using_LDR_ESP32_plus_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-auto_night_light_using_ldr_esp32_plus_micropython")
