"""
Velxio emulation test for: Battery_Monitor_with_Blynk_IoT
...
PROJECT_NAME = 'Battery_Monitor_with_Blynk_IoT'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'blynk', 'blynk_cloud']


class Test_Battery_Monitor_with_Blynk_IoT_StaticAnalysis(unittest.TestCase):
...
class Test_Battery_Monitor_with_Blynk_IoT_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-battery_monitor_with_blynk_iot")
