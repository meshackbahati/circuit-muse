...
Project: Bidirectional_ESP_NOW_Communication_with_Dual_Sensor_Nodes
Board:   esp8266
"""
...
class Test_Bidirectional_ESP_NOW_Communication_with_Dual_Sensor_Nodes_NotSupported(unittest.TestCase):
    ...
    @unittest.skip("Project not supported by Velxio: esp8266: ESP8266 has no QEMU/firmware path in Velxio.; esp_now: ESP-NOW (peer-to-peer 802.11) is not implemented in Velxio QEMU. WiFi NIC uses slirp user-mode networking, which only forwards TCP/UDP through the host stack — raw 802.11 management frames between two virtual ESP32s cannot be routed.")
