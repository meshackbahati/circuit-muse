"""
Velxio emulation test for: Blynk_Controlled_DC_Brushless_Fan
...
PROJECT_NAME = 'Blynk_Controlled_DC_Brushless_Fan'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'blynk', 'blynk_cloud']


class Test_Blynk_Controlled_DC_Brushless_Fan_StaticAnalysis(unittest.TestCase):
...
class Test_Blynk_Controlled_DC_Brushless_Fan_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-blynk_controlled_dc_brushless_fan")
