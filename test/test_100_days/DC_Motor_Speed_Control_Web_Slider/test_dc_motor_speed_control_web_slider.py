"""
Velxio emulation test for: DC_Motor_Speed_Control_(Web_Slider)
...
PROJECT_NAME = 'DC_Motor_Speed_Control_(Web_Slider)'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'servo']


class Test_DC_Motor_Speed_Control_Web_Slider_StaticAnalysis(unittest.TestCase):
...
class Test_DC_Motor_Speed_Control_Web_Slider_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-dc_motor_speed_control_web_slider")
