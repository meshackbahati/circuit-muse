"""
Velxio emulation test for: DHT11_Web_Server_using_ESP32_&_MicroPython
...
PROJECT_NAME = 'DHT11_Web_Server_using_ESP32_&_MicroPython'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'dht']


class Test_DHT11_Web_Server_using_ESP32_and_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_DHT11_Web_Server_using_ESP32_and_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-dht11_web_server_using_esp32_and_micropython")
