"""
Velxio emulation test for: Dimmer_LED_using_Potentiometer_(MicroPython)
...
PROJECT_NAME = 'Dimmer_LED_using_Potentiometer_(MicroPython)'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['servo']


class Test_Dimmer_LED_using_Potentiometer_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_Dimmer_LED_using_Potentiometer_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-dimmer_led_using_potentiometer_micropython")
