"""
Velxio emulation test for: ESP32_BLE_LED_Control
...
PROJECT_NAME = 'ESP32_BLE_LED_Control'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['ble']


class Test_ESP32_BLE_LED_Control_StaticAnalysis(unittest.TestCase):
...
class Test_ESP32_BLE_LED_Control_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-esp32_ble_led_control")
