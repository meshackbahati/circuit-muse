"""
Velxio emulation test for: ESP32_Hotspot_(Access_Point)_Setup_MicroPython
...
PROJECT_NAME = 'ESP32_Hotspot_(Access_Point)_Setup_MicroPython'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi']


class Test_ESP32_Hotspot_Access_Point_Setup_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_ESP32_Hotspot_Access_Point_Setup_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-esp32_hotspot_access_point_setup_micropython")
