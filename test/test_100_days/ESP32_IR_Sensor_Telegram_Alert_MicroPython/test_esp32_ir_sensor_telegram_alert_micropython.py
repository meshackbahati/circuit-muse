"""
Velxio emulation test for: ESP32_IR_Sensor_Telegram_Alert_(MicroPython)
...
PROJECT_NAME = 'ESP32_IR_Sensor_Telegram_Alert_(MicroPython)'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'telegram']


class Test_ESP32_IR_Sensor_Telegram_Alert_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_ESP32_IR_Sensor_Telegram_Alert_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-esp32_ir_sensor_telegram_alert_micropython")
