...
Project: ESP_NOW_HOME_AUTOMATION_WITH_TEMP_MONITORING_WITH_OLED
Board:   esp32
"""
...
class Test_ESP_NOW_HOME_AUTOMATION_WITH_TEMP_MONITORING_WITH_OLED_NotSupported(unittest.TestCase):
    ...
    @unittest.skip("Project not supported by Velxio: esp_now: ESP-NOW (peer-to-peer 802.11) is not implemented in Velxio QEMU. WiFi NIC uses slirp user-mode networking, which only forwards TCP/UDP through the host stack — raw 802.11 management frames between two virtual ESP32s cannot be routed.")
