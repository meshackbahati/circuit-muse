"""
Velxio emulation test for: IoT_Based_DSM_Smart_Metering

Board:    esp32
Features: wifi, blynk, blynk_cloud, ota
Languages: py
...
PROJECT_NAME = 'IoT_Based_DSM_Smart_Metering'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'blynk', 'blynk_cloud', 'ota']


class Test_IoT_Based_DSM_Smart_Metering_StaticAnalysis(unittest.TestCase):
...
class Test_IoT_Based_DSM_Smart_Metering_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-iot_based_dsm_smart_metering")
