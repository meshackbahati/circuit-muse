"""
Velxio emulation test for: IoT_Environment_Monitoring_With_Anomaly_Detection

Board:    esp32
Features: wifi, thingspeak, dht, ldr
Languages: py
...
PROJECT_NAME = 'IoT_Environment_Monitoring_With_Anomaly_Detection'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'thingspeak', 'dht', 'ldr']


class Test_IoT_Environment_Monitoring_With_Anomaly_Detection_StaticAnalysis(unittest.TestCase):
...
class Test_IoT_Environment_Monitoring_With_Anomaly_Detection_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-iot_environment_monitoring_with_anomaly_detection")
