"""
Velxio emulation test for: IoT_Relay_Control_Web_Server_(Raspberry_Pi_Pico_2W)
...
PROJECT_NAME = 'IoT_Relay_Control_Web_Server_(Raspberry_Pi_Pico_2W)'
PROJECT_BOARD_KIND: BoardKind = 'pico-w'
EXPECTED_FEATURES = ['wifi']


class Test_IoT_Relay_Control_Web_Server_Raspberry_Pi_Pico_2W_StaticAnalysis(unittest.TestCase):
...
class Test_IoT_Relay_Control_Web_Server_Raspberry_Pi_Pico_2W_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-iot_relay_control_web_server_raspberry_pi_pico_2w")
