"""
Velxio emulation test for: IoT_Smart_Irrigation_System
...
PROJECT_NAME = 'IoT_Smart_Irrigation_System'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'blynk', 'blynk_cloud']


class Test_IoT_Smart_Irrigation_System_StaticAnalysis(unittest.TestCase):
...
class Test_IoT_Smart_Irrigation_System_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-iot_smart_irrigation_system")
