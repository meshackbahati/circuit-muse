"""
Velxio emulation test for: Joystick_Controlled_Servo
...
PROJECT_NAME = 'Joystick_Controlled_Servo'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['servo']


class Test_Joystick_Controlled_Servo_StaticAnalysis(unittest.TestCase):
...
class Test_Joystick_Controlled_Servo_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-joystick_controlled_servo")
