"""
Velxio emulation test for: Joystick_Direction_Display_with_OLED
...
PROJECT_NAME = 'Joystick_Direction_Display_with_OLED'
PROJECT_BOARD_KIND: BoardKind = 'rp2040'
EXPECTED_FEATURES = ['i2c_oled']


class Test_Joystick_Direction_Display_with_OLED_StaticAnalysis(unittest.TestCase):
...
class Test_Joystick_Direction_Display_with_OLED_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-joystick_direction_display_with_oled")
