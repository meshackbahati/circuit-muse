"""
Velxio emulation test for: MQ4_Gas_Leak_Detection_System_using_ESP32_and_MicroPython
...
PROJECT_NAME = 'MQ4_Gas_Leak_Detection_System_using_ESP32_and_MicroPython'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = []


class Test_MQ4_Gas_Leak_Detection_System_using_ESP32_and_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_MQ4_Gas_Leak_Detection_System_using_ESP32_and_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-mq4_gas_leak_detection_system_using_esp32_and_micropython")
