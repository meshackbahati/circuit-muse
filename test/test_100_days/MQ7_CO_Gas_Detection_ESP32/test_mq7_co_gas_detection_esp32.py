"""
Velxio emulation test for: MQ7_CO_Gas_Detection_ESP32
...
PROJECT_NAME = 'MQ7_CO_Gas_Detection_ESP32'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = []


class Test_MQ7_CO_Gas_Detection_ESP32_StaticAnalysis(unittest.TestCase):
...
class Test_MQ7_CO_Gas_Detection_ESP32_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-mq7_co_gas_detection_esp32")
