"""
Velxio emulation test for: MQ_135_Gas_Sensor_with_ESP32_(MicroPython)
...
PROJECT_NAME = 'MQ_135_Gas_Sensor_with_ESP32_(MicroPython)'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['ota']


class Test_MQ_135_Gas_Sensor_with_ESP32_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_MQ_135_Gas_Sensor_with_ESP32_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-mq_135_gas_sensor_with_esp32_micropython")
