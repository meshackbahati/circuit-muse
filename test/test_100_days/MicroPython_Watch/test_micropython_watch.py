"""
Velxio emulation test for: MicroPython_Watch
...
PROJECT_NAME = 'MicroPython_Watch'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'i2c_oled']


class Test_MicroPython_Watch_StaticAnalysis(unittest.TestCase):
...
class Test_MicroPython_Watch_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-micropython_watch")
