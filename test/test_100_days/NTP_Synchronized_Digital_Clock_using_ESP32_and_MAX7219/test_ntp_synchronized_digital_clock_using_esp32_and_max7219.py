"""
Velxio emulation test for: NTP_Synchronized_Digital_Clock_using_ESP32_&_MAX7219

Board:    esp32
Features: wifi, max7219
Languages: py
...
PROJECT_NAME = 'NTP_Synchronized_Digital_Clock_using_ESP32_&_MAX7219'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'max7219']


class Test_NTP_Synchronized_Digital_Clock_using_ESP32_and_MAX7219_StaticAnalysis(unittest.TestCase):
...
class Test_NTP_Synchronized_Digital_Clock_using_ESP32_and_MAX7219_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-ntp_synchronized_digital_clock_using_esp32_and_max7219")
