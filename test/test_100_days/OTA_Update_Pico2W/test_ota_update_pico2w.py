"""
Velxio emulation test for: OTA_Update_Pico2W
...
PROJECT_NAME = 'OTA_Update_Pico2W'
PROJECT_BOARD_KIND: BoardKind = 'rp2040'
EXPECTED_FEATURES = ['wifi', 'ota']


class Test_OTA_Update_Pico2W_StaticAnalysis(unittest.TestCase):
...
class Test_OTA_Update_Pico2W_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-ota_update_pico2w")
