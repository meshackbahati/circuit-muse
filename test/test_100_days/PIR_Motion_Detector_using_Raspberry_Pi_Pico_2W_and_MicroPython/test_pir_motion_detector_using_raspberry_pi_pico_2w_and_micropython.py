"""
Velxio emulation test for: PIR_Motion_Detector_using_Raspberry_Pi_Pico_2W_&_MicroPython
...
PROJECT_NAME = 'PIR_Motion_Detector_using_Raspberry_Pi_Pico_2W_&_MicroPython'
PROJECT_BOARD_KIND: BoardKind = 'pico-w'
EXPECTED_FEATURES = []


class Test_PIR_Motion_Detector_using_Raspberry_Pi_Pico_2W_and_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_PIR_Motion_Detector_using_Raspberry_Pi_Pico_2W_and_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-pir_motion_detector_using_raspberry_pi_pico_2w_and_micropython")
