"""
Velxio emulation test for: Pico_2_W_Dht11_Http_Csv_Logger

Board:    rp2040
Features: wifi, flask, dht, http_server
Languages: py
...
PROJECT_NAME = 'Pico_2_W_Dht11_Http_Csv_Logger'
PROJECT_BOARD_KIND: BoardKind = 'rp2040'
EXPECTED_FEATURES = ['wifi', 'flask', 'dht', 'http_server']


class Test_Pico_2_W_Dht11_Http_Csv_Logger_StaticAnalysis(unittest.TestCase):
...
class Test_Pico_2_W_Dht11_Http_Csv_Logger_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-pico_2_w_dht11_http_csv_logger")
