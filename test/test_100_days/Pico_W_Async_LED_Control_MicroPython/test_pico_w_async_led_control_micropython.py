"""
Velxio emulation test for: Pico_W_Async_LED_Control_(MicroPython)
...
PROJECT_NAME = 'Pico_W_Async_LED_Control_(MicroPython)'
PROJECT_BOARD_KIND: BoardKind = 'pico-w'
EXPECTED_FEATURES = ['wifi']


class Test_Pico_W_Async_LED_Control_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_Pico_W_Async_LED_Control_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-pico_w_async_led_control_micropython")
