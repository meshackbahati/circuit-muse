"""
Velxio emulation test for: Pulse_Monitor
...
PROJECT_NAME = 'Pulse_Monitor'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['i2c_oled']


class Test_Pulse_Monitor_StaticAnalysis(unittest.TestCase):
...
class Test_Pulse_Monitor_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-pulse_monitor")
