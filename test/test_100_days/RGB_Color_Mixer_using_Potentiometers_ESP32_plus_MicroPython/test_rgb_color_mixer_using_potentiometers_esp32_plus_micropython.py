"""
Velxio emulation test for: RGB_Color_Mixer_using_Potentiometers_(ESP32_+_MicroPython)
...
PROJECT_NAME = 'RGB_Color_Mixer_using_Potentiometers_(ESP32_+_MicroPython)'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['servo']


class Test_RGB_Color_Mixer_using_Potentiometers_ESP32_plus_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_RGB_Color_Mixer_using_Potentiometers_ESP32_plus_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-rgb_color_mixer_using_potentiometers_esp32_plus_micropython")
