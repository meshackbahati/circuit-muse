"""
Velxio emulation test for: Raspberry_Pi_Pico_2_W_ThingsBoard_IoT
...
PROJECT_NAME = 'Raspberry_Pi_Pico_2_W_ThingsBoard_IoT'
PROJECT_BOARD_KIND: BoardKind = 'pico-w'
EXPECTED_FEATURES = ['wifi', 'mqtt', 'dht']


class Test_Raspberry_Pi_Pico_2_W_ThingsBoard_IoT_StaticAnalysis(unittest.TestCase):
...
class Test_Raspberry_Pi_Pico_2_W_ThingsBoard_IoT_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-raspberry_pi_pico_2_w_thingsboard_iot")
