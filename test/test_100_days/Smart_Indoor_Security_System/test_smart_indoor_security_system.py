"""
Velxio emulation test for: Smart_Indoor_Security_System
...
PROJECT_NAME = 'Smart_Indoor_Security_System'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi']


class Test_Smart_Indoor_Security_System_StaticAnalysis(unittest.TestCase):
...
class Test_Smart_Indoor_Security_System_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-smart_indoor_security_system")
