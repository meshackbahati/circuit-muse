...
Project: Soil_Moisture_Sensor_DryWet_Detection_(ESP8266_MicroPython)
Board:   esp8266
"""
...
class Test_Soil_Moisture_Sensor_DryWet_Detection_ESP8266_MicroPython_NotSupported(unittest.TestCase):
