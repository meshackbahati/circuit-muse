"""
Velxio emulation test for: Stepper_Motor_Control_using_ESP32_&_A4988_(MicroPython)
...
PROJECT_NAME = 'Stepper_Motor_Control_using_ESP32_&_A4988_(MicroPython)'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['stepper']


class Test_Stepper_Motor_Control_using_ESP32_and_A4988_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_Stepper_Motor_Control_using_ESP32_and_A4988_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-stepper_motor_control_using_esp32_and_a4988_micropython")
