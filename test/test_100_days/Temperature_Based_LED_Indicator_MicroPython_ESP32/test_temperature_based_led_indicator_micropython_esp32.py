"""
Velxio emulation test for: Temperature_Based_LED_Indicator_(MicroPython_ESP32)
...
PROJECT_NAME = 'Temperature_Based_LED_Indicator_(MicroPython_ESP32)'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi', 'servo']


class Test_Temperature_Based_LED_Indicator_MicroPython_ESP32_StaticAnalysis(unittest.TestCase):
...
class Test_Temperature_Based_LED_Indicator_MicroPython_ESP32_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-temperature_based_led_indicator_micropython_esp32")
