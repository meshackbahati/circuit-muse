"""
Velxio emulation test for: Ultrasonic_LED_Distance_Indicator_ESP32_MicroPython
...
PROJECT_NAME = 'Ultrasonic_LED_Distance_Indicator_ESP32_MicroPython'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['ultrasonic']


class Test_Ultrasonic_LED_Distance_Indicator_ESP32_MicroPython_StaticAnalysis(unittest.TestCase):
...
class Test_Ultrasonic_LED_Distance_Indicator_ESP32_MicroPython_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-ultrasonic_led_distance_indicator_esp32_micropython")
