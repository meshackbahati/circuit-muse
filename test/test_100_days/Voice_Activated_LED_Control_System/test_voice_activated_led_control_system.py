...
Project: Voice_Activated_LED_Control_System
Board:   None
"""
...
class Test_Voice_Activated_LED_Control_System_NotSupported(unittest.TestCase):
    ...
    @unittest.skip("Project not supported by Velxio: pyfirmata: Project drives an Arduino from the host via pyfirmata over a real USB serial port. There is no MCU sketch in this folder for Velxio to compile and run — only host-side desktop Python.")
