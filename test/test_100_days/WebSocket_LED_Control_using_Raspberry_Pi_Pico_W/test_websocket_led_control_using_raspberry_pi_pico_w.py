"""
Velxio emulation test for: WebSocket_LED_Control_using_Raspberry_Pi_Pico_W

Board:    pico-w
Features: wifi, websocket
Languages: py
...
PROJECT_NAME = 'WebSocket_LED_Control_using_Raspberry_Pi_Pico_W'
PROJECT_BOARD_KIND: BoardKind = 'pico-w'
EXPECTED_FEATURES = ['wifi', 'websocket']


class Test_WebSocket_LED_Control_using_Raspberry_Pi_Pico_W_StaticAnalysis(unittest.TestCase):
...
class Test_WebSocket_LED_Control_using_Raspberry_Pi_Pico_W_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-websocket_led_control_using_raspberry_pi_pico_w")
