"""
Velxio emulation test for: Wi_Fi_Controlled_4WD_Robot_Car
...
PROJECT_NAME = 'Wi_Fi_Controlled_4WD_Robot_Car'
PROJECT_BOARD_KIND: BoardKind = 'esp32'
EXPECTED_FEATURES = ['wifi']


class Test_Wi_Fi_Controlled_4WD_Robot_Car_StaticAnalysis(unittest.TestCase):
...
class Test_Wi_Fi_Controlled_4WD_Robot_Car_LiveBackend(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_backend_websocket_handshake(self):
        ...
        url = backend_websocket_url("test-100-days-wi_fi_controlled_4wd_robot_car")
