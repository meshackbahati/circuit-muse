...
Project: microclawup_AI_Powered_ESP32_GPIO_Controller_(MicroPython)
Board:   esp32
"""
...
class Test_microclawup_AI_Powered_ESP32_GPIO_Controller_MicroPython_NotSupported(unittest.TestCase):
